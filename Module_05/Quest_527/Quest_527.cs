...
namespace Module_05.Quest_527
{
    internal class Quest_527
    {
        static string ShowColor(string user_name, int user_age)
        {
            Console.WriteLine($"{user_name}, {user_age} лет {Environment.NewLine}напишите свой любимый цвет на английском с маленькой буквы");
        ...
        {
            Console.WriteLine();
            Console.WriteLine("===Запускается задание 5.2.7===");
